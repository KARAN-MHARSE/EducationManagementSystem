...
public class StudentLoginDao implements IStudentLogin {
	...
	public boolean isFirstLogin(String userName) {
		String sql = "select u.is_first_login from ems.user u "+
				"join ems.authentication a on a.user_id = u.user_id "+
				 "where username= ?";
